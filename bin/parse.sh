...
echo "Statut,Appellation,Produit,Sous Catégorie,Couleur,Sucrosité,Mention,Code INAO,id site" > data/vins.csv
...
cat data/produits.csv | grep -v ',Vins,'  > data/nonvins.csv
